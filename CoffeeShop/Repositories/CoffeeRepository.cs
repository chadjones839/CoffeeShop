    ...
    public class CoffeeRepository : ICoffeeRepository
    {
        ...
        public List<Coffee> GetAll()
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"SELECT c.Id AS CoffeeId, Title, BeanVarietyId,
                                               b.Id AS BeanId, [Name], Region, Notes
                                             FROM Coffee c
                                        LEFT JOIN BeanVariety b ON BeanVarietyId = b.Id;";
        ...
        public Coffee Get(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                        SELECT c.Id AS CoffeeId, Title, BeanVarietyId,
                               b.Id AS BeanId, [Name], Region, Notes
                          FROM Coffee c
                          LEFT JOIN BeanVariety b ON BeanVarietyId = b.Id
                         WHERE c.Id = @id;";
